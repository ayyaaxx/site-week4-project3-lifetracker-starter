...
//   const { name, email, password, username, last_name} = req.body;
...
//             INSERT INTO users (name, email, password, username, last_name)
//             VALUES ($1, $2, $3, $4, $5)
//             RETURNING *
//         `;

//     //$1 will get name, $2 will get email, $3 will get hashedPassword
//     const values = [name, email, hashedPassword, username, last_name];
